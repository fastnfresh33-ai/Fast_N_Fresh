...
router.post('/:id/checkout', checkoutOrder); // finalize/bill an unpaid table order
...
router.post('/:id/void', authorize('admin'), voidOrder); // staff/manager cannot void completed sales
