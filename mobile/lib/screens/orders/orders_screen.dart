...
class _OrdersScreenState extends State<OrdersScreen>
  ...
  /*
   * null = no successful data loaded yet.
   *
   * A non-null list, including an empty list, means we have real data.
   * If a later refresh fails, keep the previous data on screen.
   */
  List<Order>? _orders;
   ...
   * - created today
   *
   * The backend normally guarantees the unattended part, but keeping
   * this check here makes the UI safe as well.
   */
   ...
   *
   * Old QR orders will NOT keep the badge alive forever.
   */
...
class _OrderTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isNewQrOrder = _isNewQrOrder();
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
           ...
           *
           * Old open orders will use normal border.
           */
          border: Border.all(
            color: isNewQrOrder
                ? AppColors.warning
